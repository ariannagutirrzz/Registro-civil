...
def create_partida_nacimiento(dictValues: dict):
    ...
    pdf.output(name='C:\\Users\\anton\\OneDrive\\Escritorio\\pdf\\partida_nacimiento.pdf', dest='F')
...
def create_acta_matrimonio(dictValues: dict):
    ...
    pdf.multi_cell(0, 7, text)
    pdf.output(name='C:\\Users\\anton\\OneDrive\\Escritorio\\pdf\\matrimonio.pdf', dest='F')
...
def create_acta_ciudadano(dictValues: dict):
    ...
    pdf.multi_cell(0, 7, text)
    pdf.output(name='C:\\Users\\anton\\OneDrive\\Escritorio\\pdf\\ciudadania.pdf', dest='F')
...
def create_acta_defuncion(dictValues: dict):
    ...
    pdf.multi_cell(0, 7, text)
    pdf.output(name='C:\\Users\\anton\\OneDrive\\Escritorio\\pdf\\defuncion.pdf', dest='F')
...
def create_acta_divorcio(dictValues: dict):
    ...
    pdf.multi_cell(0, 7, text)
    pdf.output(name='C:\\Users\\anton\\OneDrive\\Escritorio\\pdf\\divorcio.pdf', dest='F')

def create_stadistics(listValues: list, date_start, date_end, lugar_nacimiento, parroquia):
    pdf = FPDF()
    pdf.add_page()
    pdf.set_font('Arial', 'B', 16)
    pdf.cell(100, 10,'                                                 ESTADISTICAS')
    pdf.ln(10)
    pdf.set_font('Arial', 'B', 12)
    pdf.cell(100, 10, f"TOTAL PARTIDAS DE NACIMIENTO REGISTRADAS: {listValues[0]}")
    pdf.ln(10)
    pdf.cell(100, 10, f"TOTAL HOMBRES: {listValues[1]}")
    pdf.ln(10)
    pdf.cell(100, 10, f"TOTAL MUJERES: {listValues[2]}")
    pdf.ln(10)
    pdf.cell(100, 10, f"TOTAL OTROS: {listValues[3]}")
    pdf.ln(10)
    pdf.cell(100, 10, f"TOTAL NACIDOS  {date_start} - {date_end}: {listValues[4]}")
    pdf.ln(10)
    pdf.cell(100, 10, f"TOTAL NACIDOS CIUDAD {lugar_nacimiento}: {listValues[5]}")
    pdf.ln(10)
    pdf.cell(100, 10, f"TOTAL NACIDOS PARROQUIA {parroquia}: {listValues[6]}")
    pdf.ln(10)
    pdf.cell(100, 10, f"TOTAL DE CIUDADANOS: {listValues[7]}")
    pdf.ln(10)
    pdf.cell(100, 10, f"TOTAL VENEZOLANOS: {listValues[8]}")
    pdf.ln(10)
    pdf.cell(100, 10, f"TOTAL SOLTEROS: {listValues[9]}")
    pdf.ln(10)
    pdf.cell(100, 10, f"TOTAL MATRIMONIOS: {listValues[10]}")
    pdf.ln(10)
    pdf.cell(100, 10, f"TOTAL DIVORCIOS: {listValues[11]}")
    pdf.output(name='C:\\Users\\anton\\OneDrive\\Escritorio\\pdf\\estadisticas.pdf', dest='F')